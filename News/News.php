...
<link rel="stylesheet" href="style.css">
  ...
  <body>
    <section id="posts" class=" container-fluid">
        <div class="row">
          <div class="col-12  d-flex align-items-center justify-content-center" style="background-color: rgb(188, 197, 214); height: 100px;">
              <h1 class="mt-3 text-secondary">NBPI NEWS</h1>
          </div>
      </div>
      <div class="container">
          <div class="row">
              <div class="col-12">
                  <h3 class="ms-5 text-danger">Latest News</h3>
              </div>
          </div>
          </div> 
        </section>
          ...
          <div class="col-12">
                  <ul class="trending-post">
                    <li style="list-style: none;">
                      <!-- <a href="single-post.html"><img src="./images/college gallery/IMG_0502.JPG" class="img-fluid col-lg-6"></a> -->
                      <a href="news1.html" style="text-decoration: none;">
                        <h3 >विभिन्न छाेटाे अवधि तालिमकाे अन्तर्वार्ताकाे नतिजा सम्बन्धी सूचना !</h3>
                        </a>
                        <div class="post-meta"><span class="mx-1">&bullet;</span> <span>December 5th '26</span></div>
                    </li>
                    <li class="mt-5" style="list-style: none;">
                      <a href="single-post.html"><img src="./images/college gallery/photo_2022-12-06_11-41-24.jpg" class="img-fluid col-lg-6"></a>
                    <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                      <a href="single-post.html" style="text-decoration: none;">
                        <h3>निःशुल्क पेशागत तालिमको अवसर</h3>
                      </a>
                    </li>
                    <li class="mt-5" style="list-style: none;">
                      <a href="single-post.html"><img src="./images/college gallery/IMG_0502.JPG" class="img-fluid col-lg-6"></a>
                    <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                      <a href="single-post.html" style="text-decoration: none;">
                        <h3>विदाई कार्यक्रम सम्बन्धी सूचना</h3>
                      </a>
                    </li>
                  </ul>
              </div>
